...
int main() {
	...
	double u_result[nx*ny];
	double v_result[nx*ny];
	double p_result[nx*ny];
	double b_result[nx*ny];
	...
	save_matrix_to_csv(u, "result/u-mpi.csv", nx, ny);
	save_matrix_to_csv(v, "result/v-mpi.csv", nx, ny);
	save_matrix_to_csv(p, "result/p-mpi.csv", nx, ny);
